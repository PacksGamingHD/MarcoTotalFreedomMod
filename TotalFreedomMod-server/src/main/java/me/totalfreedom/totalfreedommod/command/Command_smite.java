...
public class Command_smite extends FreedomCommand
{
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        smite(player, playerSender, reason);
        return true;
    }

    public static void smite(Player player, Player sender)
    {
        smite(player, sender, null);
    }

    public static void smite(Player player, Player sender, String reason)
    {
        ...
        player.sendMessage(ChatColor.RED + "Smitten by: " + sender.getName());
